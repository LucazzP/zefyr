...
class EditorTextSelectionOverlay {
  ...
  Widget _buildHandle(BuildContext context, _TextSelectionHandlePosition position) {
    if ((_selection.isCollapsed && position == _TextSelectionHandlePosition.end) ||
        selectionControls == null) return Container(); // hide the second handle when collapsed
    return Visibility(
  ...
  Widget _buildToolbar(BuildContext context) {
    ...
    final bool isMultiline =
        endpoints.last.point.dy - endpoints.first.point.dy > smallestLineHeight / 2;
...
class _TextSelectionHandleOverlayState extends State<_TextSelectionHandleOverlay>
  ...
  void initState() {
    ...
    _controller =
        AnimationController(duration: EditorTextSelectionOverlay.fadeDuration, vsync: this);
